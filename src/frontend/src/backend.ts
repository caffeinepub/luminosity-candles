...
export class Backend implements backendInterface {
    ...
    async getAllCollections(): Promise<Array<CandleCollection>> {
    ...
    async getProductById(arg0: bigint): Promise<CandleProduct> {
        if (this.processError) {
            try {
    ...
    async getProductsByCollectionId(arg0: bigint): Promise<Array<CandleProduct>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByCollectionId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
